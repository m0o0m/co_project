...
<template>
<div :class="{'westernBack_01':creditId == 5 ,'westernBacks_01':creditId == 5 , 'westernBack_nc':creditId == 17}" class="westernFooter">
  <div class="westernFooter_mian" v-if=" creditId != 5  ">
    <!--<div class="westernFooter_top"  v-show="creditId != 17 ">-->
      <!--<ul>-->
    ...
    <div class="westernFooter_top">
      <section class="westernSectionNum">
        <p v-for="(mary,marry_index) in marryImg" data-marry="data.num" :class="{'on':marryImgId == marry_index}" @click="marryClick(marry_index, mary.num)" :data-Marry="mary.num">
          <img :src="mary.img"/>
        </p>
      </section>
    </div>
    <article class="westernFooter_bottom">
      ...
      <!--<section class="westernSectionNum">-->
        ...
        <!--</p>-->
      <!--</section>-->
      <section><a href="javascript:void(0)" @click="onConfirmBtnClicked">{{$parent.classAdata.status === 0 || $parent.classAdata.status === -1 ? '暂停销售' : '立即投注'}}</a></section>
    </article>
  </div>

  <!--北京pk10-->
  <div class="bjpk10Footer_mian" v-if="creditId == 5">
    <article class="footerArticle_bjpk10">
      <section class="westernSectionNum">
        <p v-for="(mary,marry_index) in marryImg" data-marry="data.num" :class="{'on':marryImgId == marry_index}" @click="marryClick(marry_index, mary.num)" :data-Marry="mary.num"><img :src="mary.img"/><img :src="mary.img" class="maryCls"/></p>
      </section>
    </article>
    <!--<div class="bjpk10Footer_top">-->
      <!--<ul>-->
        <!--<li @click="increaseClick"></li>-->
        <!--<li>-->
          <!--<div class="westernCirText">-->
            ...
            <!--<p><span>8</span>%</p>-->
          <!--</div>-->
          <!--<div class="westernCir_bjpk10 dragMan_maxline">-->
            <!--<p class="westernWhite"></p>-->
            <!--<p class="westernYellow westernYellowBJPK10 dragMan_redLine"></p>-->
            <!--<strong class="westernYeQiu westernBJPK10 dragMan_minline"></strong>-->
          <!--</div>-->
        <!--</li>-->
        <!--<li @click="reduceClick"></li>-->
      <!--</ul>-->
    <!--</div>-->
    <!--投注-->
    <div class="footerBjpk10">
      <p @click="resetData(true)"><img src="../assets/images/qz.png"/></p>
      <p @click="onConfirmBtnClicked"><img :src="picture"/></p>
    </div>
  </div>
</div>
</template>
