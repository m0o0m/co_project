<template>
    <div class="confirmPage" v-show="bankId">
        <article class="headerTop headerTopWei">
            <section @click="sectionClick"></section>
        ...
        <div :class="{'confirmClsxG':creditId == 3,
            ...
            <div class="confirmCls_mian">
                <div :class="{bjpk10_confirmCls_bg:creditId == 5}">
                    <div class="confirmClsTop"></div>
                    <div class="confirmbreak">
                        ...
                        <div class="confirmListed">
                            <ul>
                                <li v-for="(order,index) in orders">
                                    <p><span>{{order.colorfulName}}:{{order.data}}</span></p>
                                    <p><span>{{order.odds}}</span></p>
                                    <p><span>¥{{order.multiple}}</span></p>
                                    <a href="javascript:void(0)" @click="deleteOrder(index)"><img :src="iconDel"/></a>
                                </li>
                            </ul>
                        </div>
                    </div>
