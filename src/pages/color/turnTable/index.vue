...
//          that.countDownSecond = 35;
      ...
      makeOrder: function () {
        ...
        console.log(this.$refs.confirmPageRef);
...
<style lang="scss">
    .bodys {
        /*background: url('../../../assets/images/turnTable/bgd_01.png') top center repeat-y; background-size: 100% auto;*/
        background: linear-gradient(top, #123821, #164227);
        background: -webkit-linear-gradient(top, #123821, #164227);
    }
