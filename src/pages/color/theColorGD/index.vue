...
<script>
	...
	export default {
		data() {
			return {
				icon: require('../../../assets/images/index/icon/23-.png'),
				classAdata: "",
				creditId: "",
				nextNoisser: "",
				Noisser: "",
		...
		methods: {
			initData() {
				let that = this;
				that._Util.post(that, that._Api.POST_LOTTERY_DETAIL, {id: 23}, (data) => {
