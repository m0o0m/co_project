  ...
  <div class="ColorLotteryMuned ColorLotteryMuned12">
    <div class="colorLotteryMargin">
      ...
      <div class="ColorLottery_mian ColorLottery_mian12" :class="{'ColorLot_mian12':lotteryOffsColorID == '275'}">
        <div class="ColorLottery_mcontent ColorLottery_mcontent12" v-for="(lotData,index) in deafNum"
             v-if="lotteryOffsColorID == '299' && index == 0 || lotteryOffsColorID != '299'"
              ...
              <li v-for="(lData,lData_index) in (items.length ? items : lotData.played)"
                ...
                <article
                  ...
                  <section :class="{'ColorLot_Colorsection': lotteryOffsColorID == '293'}">
                    <p><span
                        v-if="lotteryOffsColorID != '289' && lotteryOffsColorID != '291'">{{lData.name}}</span><span
                    ...
                    <p class="playMarryImg imggs lists "
                      ...
                      <img v-if="lData.active"
                           :src="require('../../../assets/images/marry_' + ((lData.chip === 10 || lData.chip === 5000) ? lData.chip + '_f' : lData.chip) + '.png')"/>
                    </p>
                ...
                <article class="ColorLot_article_illustrating">
                  ...
                  <section>
                    <article class="colorLot_articleP" v-for="(lus, lus_index) in lustrating.played"
                      ...
                      <p class="playMarryImg imggs playMarryImg_lhd" v-if="lus.active && !$parent.stopBet"><img
