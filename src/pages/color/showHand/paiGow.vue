      ...
      <div class="paiGow sHGow paiGow_sHGow">
        ...
        <div class="paiGow_mian paiGow_mian_showHand">
          <div class="paiGow_mian_showHand_back">
            ...
            <div  v-for="(Colorful,item_index) in deafNum"  class="mnshDiv" v-show="item_index == ColorfulID || lotteryOffsColorID == 125 || lotteryOffsColorID == 327">
              <!-- <div>{{Colorful.name}}</div> -->

              <div class="paiGow_mun  paiGow_muns paiGow_mun_ltery" :class="{'paiGow_mun_LHeight': lotteryOffsColorID != 321 ,'paiGow_mun_RHeight': lotteryOffsColorID == 321}">
                <ul v-if="lotteryOffsColorID == 125 || lotteryOffsColorID == 327">
                  <li v-for="(play,index) in Colorful.played" :class="{'on': play.active}">
                    <article @click="playchecked($event,play,Colorful.id,play.name,index, Colorful,'',item_index)" :class="{'on':play.active}" class="paiGow_article shGow_article">
                      <section style="overflow: visible" >
                        ...
                        <p class="playMarryImg" v-if="play.active && !$parent.stopBet">  <img src="../../../assets/images/small01.png" alt=""></p>
                      </section>
                      <section>
                ...
                <ul v-if="lotteryOffsColorID == 321" class="paiGow_integrateCred00">
                  <li v-for="(play,index) in Colorful.played" :class="{'on': play.active}">
                    <article style="overflow: visible" @click="playchecked($event,play,Colorful.id,play.name,index, Colorful,'',item_index)" :class="{'on':play.active}" class="paiGow_integrate">
                      ...
                      <p class="playMarryImg imggs" v-if="play.active && !$parent.stopBet">  <img src="../../../assets/images/small01.png" alt=""></p>
                    </article>
                  </li>
                </ul>
                <!--龙虎斗-->
                <div class="paiGow_integrateCred_mianed paiGow_muns" v-for="(Colorfuled,Colorfuled_index) in  ColorFUlillustrating" v-if="lotteryOffsColorID == 329">
                  <div class="paiGow_integrateCred_title" >{{Colorfuled.name}}</div>
                  <ul class="paiGow_integrateCred00">
                    <li v-for="(play,index) in Colorfuled.played" :class="{'on': play.active,'colorfuledLast':lotteryOffsColorID == 329}">
