<template>
  <div class="tempDiv tempDiv_racing">
    <Headered
    ...
    <DrawLottery v-if="isOpenLottery"></DrawLottery>
  </div>
</template>
...
<script type="text/babel">
  ...
  import DrawLottery from './drawLottery.vue'
  ...
  export default {
    data () {
      return {
        ...
        classAdata: '',//一级数据
        creditId: 1,//彩种ID
        icon: require('../../../assets/images/index/icon/14.png'),//彩种图标
        rule: '',//彩种规则
...
<style lang="scss">
  .tempDiv_racing {
    background: linear-gradient(top,#255e8b,#16406f); background: -webkit-linear-gradient(top,#255e8b,#16406f);
  }
</style>
