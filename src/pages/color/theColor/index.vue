...
<script>
  ...
  export default {
    data() {
      return {
        icon: require('../../../assets/images/index/icon/24-.png'),
        classAdata: "",
        creditId: "",
        nextNoisser: "",
        Noisser: "",
    ...
    mounted() {
      ...
      that._Util.setCss('.theColor02', {"min-height": 1}, "*");
      that._Util.visibilityChange(that, 24);
    },
    methods: {
      initData() {
        let that = this;
