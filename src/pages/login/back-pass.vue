  ...
  <div class="loginIndex">
    <div class="loginPad">
      ...
      <div class="verificationCall" v-if="showXy == '2'">
        <div class="loginName">
          <ul>
            ...
            <li class="loginLi displayFlex">
              <p>验证码</p>
              <p class="relatively">
                <input v-model="user.code" type="text" placeholder="请输入用户名" maxlength="12"/><input @click="getyzm()"
        ...
        <div class="loginHostBtn" @click="pass()"><a href="javascript:void(0)">下一步</a></div>
      </div>
      <!--设置密码-->
      <div class="setUpPaw" v-if="showXy == '3'">
        <div class="loginName">
          <ul>
            <li class="loginLi displayFlex">
              <p>设置密码</p>
              <p><input v-model="user.password" type="password" placeholder="请输入6～12位数字或字母" maxlength="12"
            ...
            <li class="loginLi displayFlex">
              <p>确认密码</p>
              <p>
                <input v-model="user.password2" type="password" placeholder="请输入6～12位数字或字母" maxlength="12"
                       onkeyup="value=value.replace(/[\W]/g,'') "
                       onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))"/>
              </p>
            </li>
