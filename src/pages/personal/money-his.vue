    ...
    <div id="moneyHisTemplate" class="moneyHisTemplate">
        ...
        <div v-infinite-scroll="loadMore"
            ...
            <ul v-else>
                ...
                <li v-for="(money,index) in moneyExport">
                    <div class="moneyMian">
                        <div class="moneyLeft" :class="{'moneyRed': money.status == '2','moneyYellow': money.status == '1', 'moneyGray': money.status == '0' || money.status == '3'}"></div>
...
<style lang='scss'>
    ...
    /*}*/
    .moneyHisTemplate {
        background: url('../../assets/images/index/bg.png') center center no-repeat; background-size: cover;
    }
</style>
