<template>
    <div class="moneyTemplateed">
        <div class="template_card template_card_bank" style="background: transparent">
            ...
            <span style="background: #ffffff; border: 0.1rem solid #ffffff; width: 0.75rem; height: 0.75rem; display: inline-block; border-radius: 50%; position: relative; top: 0.2rem; left: -0.2rem;"><img
