    ...
    <div class="lineChart" style="position: relative;">
        ...
        <div id="chartForm">
            <div class="chartFormDiv">
                <div class="lineChart_titleIos" v-if="!$route.query.terminal && (cid === 5 || cid === 23 || cid === 24 || cid === 14 || cid === 22)"></div>
                <div class="lineChart_titleIos1" v-if="!$route.query.terminal && (cid === 1 || cid === 2 || cid === 13 || cid === 21 || ((cid === 15 || cid === 16 || cid === 18) && chartId == 1))"></div>
                ...
                <div class="lineChart_titleIos4" v-if="!$route.query.terminal && (((cid === 3 || cid === 12) && chartId < 2) || ((cid === 15 || cid === 16 || cid === 18) && chartId < 1))"></div>
                <div class="lineChart_titleIos5" v-if="!$route.query.terminal && ((cid === 3 || cid === 12) && chartId === 2)"></div>
                <div class="lineChart_titleIos6" v-if="!$route.query.terminal && (((cid === 15 || cid === 16 || cid === 18) && chartId === 1))"></div>
                ...
                <div class="chartColor" v-if="chartData">
                    ...
                    <article class="chartDouble chartFix" v-for="(dar,data_index) in chartDataNav"
                        ...
                        <p v-for="(v,v_index) in dar.data" :class="{'one': v_index === 0, 'two': v_index > 0}"><span><a href="#" style="color: #fff">{{v}}</a></span>
                        </p>
                    </article>
