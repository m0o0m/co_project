...
;(function($, window, document, undefined){
	...
	function SlotMachine(element, options){
		...
		//Set max top offset
		this._maxTop = - this.$container.height()*3;
	...
	SlotMachine.prototype.getTileOffset = function(index){
		...
		for(var i=0; i<index; i++){
			offset += $( this.$tiles.get(i) ).outerHeight()+10;
			// offset += 91;
			console.log("offset",$(this.$tiles.get(i)).outerHeight());
		}

		console.log("_minTop:",- offset+this._minTop)
